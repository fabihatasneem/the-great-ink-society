...
<!-- Scripts -->
<script src="js/global/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
<script src="js/global/popper.min.js"></script> <!-- Popper tooltip library for Bootstrap -->
<script src="js/global/bootstrap.min.js"></script> <!-- Bootstrap framework -->
<script src="js/global/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
