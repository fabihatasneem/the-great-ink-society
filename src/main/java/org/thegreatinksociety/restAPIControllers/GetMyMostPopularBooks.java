...
@RestController
public class GetMyMostPopularBooks {

    @Autowired
    private BooksRepository booksRepository;

    @RequestMapping(value = "/getMyMostPopularBooks", method = RequestMethod.POST)
    public List<Books> getMyMostPopularBooks(@RequestParam Long userId){
