...
@RestController
public class GetMyMostPopularPodcasts {

    @Autowired
    private PodcastSeriesRepository podcastSeriesRepository;

    @RequestMapping(value = "/getMyMostPopularPodcasts", method = RequestMethod.POST)
    public List<PodcastSeries> getMyMostPopularBooks(@RequestParam Long userId){
